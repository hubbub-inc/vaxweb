    ...
    return Scaffold
      (
        appBar: AppBar
          ...
          title: Text('VaxBud', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 30.0)),
          actions: <Widget>
          [
            Container
              (
                    ...
                    [
                      Column
                        ...
                        [
                          ...
                          Text('GUEST', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0))
                        ],
                      ),
                      Material
                        (
                ...
                child: Column
                  (
                    ...
                    [
                      ...
                      Text('Location', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                      Text('search or use gps to find vax and testing location', style: TextStyle(color: Colors.black45)),
                    ]
                ),
              ),
            ),
                ...
                child: Column
                  (
                    ...
                    [
                      ...
                      Padding(padding: EdgeInsets.only(bottom: 16.0)),
                      Text('Schedule', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                      Text('find appointment times that fit your schedule', style: TextStyle(color: Colors.black45)),
                    ]
                ),
              ),
            ),
                      ...
                      Material
                        (
                          ...
                          child: Padding
                            (
                            padding: const EdgeInsets.all(16.0),
                            child: Icon(Icons.check_box, color: Colors.white, size: 30.0),
                          )
                      ),
                      Padding(padding: EdgeInsets.only(bottom: 16.0)),
                      Text('Appointments', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                      Text('No current or pending appointments', style: TextStyle(color: Colors.black45)),
                    ]
                ),
              ),
            ),
